...
<main class="dashboard-cardLayouts">
	...
	<section class="module-index module">
		<div class="module-header">
			<h2>
				DL Card Templates
				<a href="{{ URL::route('cardLayout.create') }}" class="add-new">
		...
		@foreach ($cardLayouts as $index => $layout)
				...
				<header data-header-id="{{ $index }}" data-layout-id="{{ $layout->id }}">
					...
					{{ Form::open(array('route' => 'cardLayout.destroy', 'method' => 'delete', 'class' => 'layout-delete delete crud', 'data-ajax' => URL::route('ajax.cardLayouts.destroy'))) }}
